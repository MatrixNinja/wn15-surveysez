 ...
 * 
 * @package SurveySez
 * @author Emilio Garduno <hitsone@gmail.com>
...
<p>This page is the entry point of the application, meaning this page gets a link on your web site.  Since the current subject is surveys, we could name the link something clever like <a href="<?php echo VIRTUAL_PATH; ?>surveys/survey_list.php">Surveys</a></p>
<p>Use <b>survey_list.php</b> and <b>survey_view.php</b> as a starting point for building your own List/View web application!</p> 
<?php
...
$sql = $myPager->loadSQL($sql);  #load SQL, add offset depending on the myPager size above: 1-10, 11-20, etc.
